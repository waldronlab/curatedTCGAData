...
refer to the [References](#references) section to see the @Ramos2020-cci
citation. For the BibTeX entry, run the `citation` function (after
installation):
...
You may also want to see the PDF of our publication on
[JCO Clinical Cancer Informatics][1].

[1]: https://ascopubs.org/doi/pdf/10.1200/CCI.19.00119
